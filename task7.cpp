...
int main()
{
    runge_kutta_adaptive(1.0, 0.0, 0.1, 1e-7, "task7-t7.csv", "task7-t7-delta.csv");
    runge_kutta_adaptive(1.0, 0.0, 0.1, 1e-8, "task7-t8.csv", "task7-t8-delta.csv");
    runge_kutta_adaptive(1.0, 0.0, 0.1, 1e-9, "task7-t9.csv", "task7-t9-delta.csv");
    return 0;
}